...
define('C_CREA_ANNO_MANUALMENTE',"NUOVO"); # SI, NO or NUOVO to allow creation of new year only when it has begun
...
define('C_MINIMA_LUNGHEZZA_PASS',"4");
...
#if (!defined('C_NUM_HOSTING')) define('C_NUM_HOSTING',"");
...
define('C_PASSWORD_BOOKINGCOM_IC',"NOAUTH"); # NOAUTH to don't use old authentication
define('C_CLIENT_ID_BOOKINGCOM_IC',"");
define('C_CLIENT_SECRET_BOOKINGCOM_IC',"");
