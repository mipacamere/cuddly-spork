...
case "raggruppa le date":  			$messaggio = "agrupar las fechas"; break;
...
case "Numero di persone minimo per la tariffa":	$messaggio = "Número de personas mínimo para la tarifa"; break;
