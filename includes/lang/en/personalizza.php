...
case "percorsi relativi":  			$messaggio = "paths relative"; break;
...
case "Secondo cognome disattivato":  		$messaggio = "Second surname disabled"; break;
case "Secondo cognome attivato":  		$messaggio = "Second surname enabled"; break;
case "Fuso orario":  				$messaggio = "Time zone"; break;
case "nessun fuso orario":  			$messaggio = "no time zone"; break;
case "Si possono creare solo cartelle con nome composto da lettere e numeri":	$messaggio = "Only folders with names that contain letters and numbers can be created"; break;
case "la seguente cartella verrà creata":  	$messaggio = "the following folder will be created"; break;
