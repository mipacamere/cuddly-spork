...
$attiva_regole1_consentite = fixset($attiva_regole1_consentite_gr[$idut_gr]);
$regole1_consentite = fixset($regole1_consentite_gr[$idut_gr]);
$priv_mod_assegnazione_app = fixset($priv_mod_assegnazione_app_gr[$idut_gr]);
$priv_mod_prenotazioni = fixset($priv_mod_prenotazioni_gr[$idut_gr]);
$priv_ins_assegnazione_app = fixset($priv_ins_assegnazione_app_gr[$idut_gr]);
$priv_ins_nuove_prenota = fixset($priv_ins_nuove_prenota_gr[$idut_gr]);
$attiva_tariffe_consentite = fixset($attiva_tariffe_consentite_gr[$idut_gr]);
$tariffe_consentite_vett = fixset($tariffe_consentite_vett_gr[$idut_gr]);
