...
$tariffa_colonna_periodo[$num1][$num_colonne_periodi] = (float) risul_query($periodi,$inizioperiodi_id[$num_p],$tariffa[$num1]);
$tariffap_colonna_periodo[$num1][$num_colonne_periodi] = (float) risul_query($periodi,$inizioperiodi_id[$num_p],$tariffa[$num1]."p");
if (isset($dati_r2['napp'][$tariffa[$num1]]) and $dati_r2['napp'][$tariffa[$num1]] > 1) {
$tariffa_colonna_periodo[$num1][$num_colonne_periodi] = $tariffa_colonna_periodo[$num1][$num_colonne_periodi] * (float) $dati_r2['napp'][$tariffa[$num1]];
#$tariffap_colonna_periodo[$num1][$num_colonne_periodi] = $tariffap_colonna_periodo[$num1][$num_colonne_periodi] * (float) $dati_r2['napp'][$tariffa[$num1]];
...
$tar_corr = (float) risul_query($periodi,($inizioperiodi_id[$num_p] + $num_i),$tariffa[$num1]);
$tarp_corr = (float) risul_query($periodi,($inizioperiodi_id[$num_p] + $num_i),$tariffa[$num1]."p");
if (isset($dati_r2['napp'][$tariffa[$num1]]) and $dati_r2['napp'][$tariffa[$num1]] > 1) {
$tar_corr = $tar_corr * (float) $dati_r2['napp'][$tariffa[$num1]];
#$tarp_corr = $tarp_corr * (float) $dati_r2['napp'][$tariffa[$num1]];
} # fine if (isset($dati_r2['napp'][$tariffa[$num1]]) and $dati_r2['napp'][$tariffa[$num1]] > 1)
$tariffa_colonna_periodo[$num1][$num_colonne_periodi] += $tar_corr;
$tariffap_colonna_periodo[$num1][$num_colonne_periodi] += $tarp_corr;
if (!empty($dati_tariffe[$tariffa[$num1]]['chiusa'][($inizioperiodi_id[$num_p] + $num_i + 1)])) {
$tariffa_colonna_periodo[$num1][$num_colonne_periodi] = "c";
$tariffap_colonna_periodo[$num1][$num_colonne_periodi] = "c";
} # fine if (!empty($dati_tariffe[$tariffa[$num1]]['chiusa'][($inizioperiodi_id[$num_p] + $num_i + 1)]))
} # fine for $num_i
...
${$tariffa[$num2]} = (float) risul_query($periodi,$num1,$tariffa[$num2]);
${$tariffa[$num2]."p"} = (float) risul_query($periodi,$num1,$tariffa[$num2]."p");
if (isset($dati_r2['napp'][$tariffa[$num2]]) and $dati_r2['napp'][$tariffa[$num2]] > 1) {
${$tariffa[$num2]} = ${$tariffa[$num2]} * (float) $dati_r2['napp'][$tariffa[$num2]];
#${$tariffa[$num2]."p"} = ${$tariffa[$num2]."p"} * (float) $dati_r2['napp'][$tariffa[$num2]];
...
$tar_corr = (float) risul_query($periodi,($num1 + $num_i),$tariffa[$num2]);
$tarp_corr = (float) risul_query($periodi,($num1 + $num_i),$tariffa[$num2]."p");
if (isset($dati_r2['napp'][$tariffa[$num2]]) and $dati_r2['napp'][$tariffa[$num2]] > 1) {
$tar_corr = $tar_corr * (float) $dati_r2['napp'][$tariffa[$num2]];
#$tarp_corr = $tarp_corr * (float) $dati_r2['napp'][$tariffa[$num2]];
} # fine if (isset($dati_r2['napp'][$tariffa[$num2]]) and $dati_r2['napp'][$tariffa[$num2]] > 1)
${$tariffa[$num2]} += $tar_corr;
${$tariffa[$num2]."p"} += $tarp_corr;
if (!empty($dati_tariffe[$tariffa[$num2]]['chiusa'][($num1 + $num_i + 1)])) {
${$tariffa[$num2]} = "c";
${$tariffa[$num2]."p"} = "c";
} # fine if (!empty($dati_tariffe[$tariffa[$num2]]['chiusa'][($num1 + $num_i + 1)]))
} # fine for $num_i
