...
$righe_tab_disp = "";
if ($return_var) $tab_liberi = array();
...
if (empty($dati_r2["tariffa$numtariffa"])) {
$tutti_consentiti = "SI";
break;
} # fine if (empty($dati_r2["tariffa$numtariffa"]))
else {
...
} # fine else if (empty($dati_r2["tariffa$numtariffa"]))
...
if (!isset($appartamenti_consentiti_regola2[$idapp]) or $appartamenti_consentiti_regola2[$idapp] != "SI") {
$app_consentito[$idapp] = "NO";
$quadro_non_preciso = "SI";
} # fine if (!isset($appartamenti_consentiti_regola2[$idapp]) or $appartamenti_consentiti_regola2[$idapp] != "SI")
} # fine for $num1
