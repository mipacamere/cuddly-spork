...
$prefisso_clienti = (string) risul_query($privilegi_globali,0,'prefisso_clienti');
...
for ($num1 = 0 ; $num1 < fixset(${"num_motivazioni".$anno_modifica}) ; $num1++) if (!empty(${"var_mot_".$anno_modifica.$num1})) $nuove_motivazioni_sel .= "#@^".${"var_mot_".$anno_modifica.$num1};
if ($nuove_motivazioni_sel) $nuove_motivazioni_sel = substr($nuove_motivazioni_sel,3);
if (htmlspecialchars($nuove_motivazioni_sel,ENT_COMPAT) != substr($regole1_consentite,3)) {
...
} # fine if (htmlspecialchars($nuove_motivazioni_sel$regole1_consentite) != substr($regole1_consentite,1)
if (substr($regole1_consentite,1,1) != fix_set(${"avvisa_regola1".$anno_modifica})) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"avvisa_regola1\" value=\"".htmlspecialchars((string) ${"avvisa_regola1".$anno_modifica})."\">";
...
if (substr($tariffe_consentite,0,1) != fix_set(${"seleziona_tariffe".$anno_modifica})) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"seleziona_tariffe\" value=\"".htmlspecialchars((string) ${"seleziona_tariffe".$anno_modifica})."\">";
...
} # fine if (substr($tariffe_consentite,0,1) != fixset(${"seleziona_tariffe".$anno_modifica}))
$nuove_tariffe_sel = "";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"seleziona_costi_agg\" value=\"".htmlspecialchars((string) ${"seleziona_costi_agg".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"seleziona_contratti\" value=\"".htmlspecialchars((string) ${"seleziona_contratti".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"cancella_contr\" value=\"".htmlspecialchars((string) ${"cancella_contr".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"inserisci_prenotazioni\" value=\"".htmlspecialchars((string) ${"inserisci_prenotazioni".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_assegnazione_app\" value=\"".htmlspecialchars((string) ${"ins_assegnazione_app".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_conferma_prenota\" value=\"".htmlspecialchars((string) ${"ins_conferma_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_sconto\" value=\"".htmlspecialchars((string) ${"ins_sconto".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_caparra\" value=\"".htmlspecialchars((string) ${"ins_caparra".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_checkin\" value=\"".htmlspecialchars((string) ${"ins_checkin".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_costi_agg_prenota\" value=\"".htmlspecialchars((string) ${"ins_costi_agg_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_commento\" value=\"".htmlspecialchars((string) ${"ins_commento".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_comm_pers\" value=\"".htmlspecialchars((string) ${"ins_comm_pers".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_origine_prenota\" value=\"".htmlspecialchars((string) ${"ins_origine_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_num_persone\" value=\"".htmlspecialchars((string) ${"ins_num_persone".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_passato\" value=\"".htmlspecialchars((string) ${"ins_passato".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_multiple\" value=\"".htmlspecialchars((string) ${"ins_multiple".$anno_modifica})."\">";
...
if (fix_set(${"modp_prenota".$anno_modifica}) == "p" and fixset(${"modp_prenota_gr".$anno_modifica}) == "SI") ${"modp_prenota".$anno_modifica} = "g";
if (substr($priv_mod_prenota,0,1) != ${"modp_prenota".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_prenota\" value=\"".htmlspecialchars((string) ${"modp_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_cliente\" value=\"".htmlspecialchars((string) ${"modp_cliente".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_date_prenota\" value=\"".htmlspecialchars((string) ${"modp_date_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_app_prenota\" value=\"".htmlspecialchars((string) ${"modp_app_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_pren_comp\" value=\"".htmlspecialchars((string) ${"modp_pren_comp".$anno_modifica})."\">";
...
if (fix_set(${"modp_tariffa".$anno_modifica}) == "n" and fixset(${"modp_vedi_tariffa".$anno_modifica}) == "SI") ${"modp_tariffa".$anno_modifica} = "v";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_tariffa\" value=\"".htmlspecialchars((string) ${"modp_tariffa".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_num_persone\" value=\"".htmlspecialchars((string) ${"modp_num_persone".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_vedi_comm\" value=\"".htmlspecialchars((string) ${"modp_vedi_comm".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_commento\" value=\"".htmlspecialchars((string) ${"modp_commento".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_comm_pers\" value=\"".htmlspecialchars((string) ${"modp_comm_pers".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_origine_prenota\" value=\"".htmlspecialchars((string) ${"modp_origine_prenota".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_checkin\" value=\"".htmlspecialchars((string) ${"modp_checkin".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_sconto\" value=\"".htmlspecialchars((string) ${"modp_sconto".$anno_modifica})."\">";
...
if (fix_set(${"modp_caparra".$anno_modifica}) == "n" and fixset(${"modp_vedi_caparra".$anno_modifica}) == "SI") ${"modp_caparra".$anno_modifica} = "v";
if (substr($priv_mod_prenota,7,1) != ${"modp_caparra".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_caparra\" value=\"".htmlspecialchars((string) ${"modp_caparra".$anno_modifica})."\">";
...
if (fix_set(${"modp_costi_agg".$anno_modifica}) == "n" and fixset(${"modp_vedi_prezzi_ca".$anno_modifica}) == "SI") ${"modp_costi_agg".$anno_modifica} = "v";
if (${"modp_costi_agg".$anno_modifica} == "n" and fixset(${"modp_vedi_prezzi_ca".$anno_modifica}) == "VL") ${"modp_costi_agg".$anno_modifica} = "p";
if (substr($priv_mod_prenota,8,1) != ${"modp_costi_agg".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_costi_agg\" value=\"".htmlspecialchars((string) ${"modp_costi_agg".$anno_modifica})."\">";
...
if (fix_set(${"modp_pagato".$anno_modifica}) == "n" and fixset(${"modp_nm_vedi_prezzi".$anno_modifica}) == "SI") ${"modp_pagato".$anno_modifica} = "v";
if (${"modp_pagato".$anno_modifica} == "c" and fixset(${"modp_sc_vedi_prezzi".$anno_modifica}) == "NO") ${"modp_pagato".$anno_modifica} = "i";
if (substr($priv_mod_prenota,10,1) != ${"modp_pagato".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_pagato\" value=\"".htmlspecialchars((string) ${"modp_pagato".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_cassa_pagamenti\" value=\"".htmlspecialchars((string) ${"modp_cassa_pagamenti".$anno_modifica})."\">";
...
if (fix_set(${"modp_ut_ins".$anno_modifica}) == "n" and fixset(${"modp_vedi_utins".$anno_modifica}) == "SI") ${"modp_ut_ins".$anno_modifica} = "v";
if (${"modp_ut_ins".$anno_modifica} == "s" and fixset(${"modp_utenti".$anno_modifica}) == "SI") ${"modp_ut_ins".$anno_modifica} = "g";
if (substr($priv_mod_prenota,9,1) != ${"modp_ut_ins".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_ut_ins\" value=\"".htmlspecialchars((string) ${"modp_ut_ins".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_codice\" value=\"".htmlspecialchars((string) ${"modp_codice".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_gia_iniziate\" value=\"".htmlspecialchars((string) ${"modp_gia_iniziate".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_attiva_ore_mod\" value=\"".htmlspecialchars((string) ${"modp_attiva_ore_mod".$anno_modifica})."\">
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_canc\" value=\"".htmlspecialchars((string) ${"modp_canc".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_canc_perm\" value=\"".htmlspecialchars((string) ${"modp_canc_perm".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_canc_dopo_conf\" value=\"".htmlspecialchars((string) ${"modp_canc_dopo_conf".$anno_modifica})."\">";
...
if ($v_modp_attiva_ore_canc != fix_set(${"modp_attiva_ore_canc".$anno_modifica}) or (substr($priv_mod_prenota,15,3) != fixset(${"modp_num_ore_canc".$anno_modifica}) and ${"modp_attiva_ore_canc".$anno_modifica} == "s")) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"modp_attiva_ore_canc\" value=\"".htmlspecialchars((string) ${"modp_attiva_ore_canc".$anno_modifica})."\">
<input type=\"hidden\" name=\"modp_num_ore_canc\" value=\"".htmlspecialchars(fixstr(${"modp_num_ore_canc".$anno_modifica}))."\">";
...
if (${"modp_attiva_ore_canc".$anno_modifica} == "s") echo mex("L'utente",$pag)." <i>$nome_utente_privilegi</i> ".mex("non potrà più cancellare le prenotazioni <b>dopo",$pag)." ".fixset(${"modp_num_ore_canc".$anno_modifica})." ".mex("ore</b> nel",$pag)." $anno_modifica.<br>";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_spese\" value=\"".htmlspecialchars((string) ${"ins_spese".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_entrate\" value=\"".htmlspecialchars((string) ${"ins_entrate".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"sottrai_entrate\" value=\"".htmlspecialchars((string) ${"sottrai_entrate".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"persona_spese\" value=\"".htmlspecialchars((string) ${"persona_spese".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"mod_tariffe\" value=\"".htmlspecialchars((string) ${"mod_tariffe".$anno_modifica})."\">";
...
if (fix_set(${"mod_reg1".$anno_modifica}) == "s" and (fix_set(${"mod_reg1_tipo".$anno_modifica}) == "a" or ${"mod_reg1_tipo".$anno_modifica} == "t")) ${"mod_reg1".$anno_modifica} = ${"mod_reg1_tipo".$anno_modifica};
if (substr($priv_ins_tariffe,4,1) != ${"mod_reg1".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"mod_reg1\" value=\"".htmlspecialchars((string) ${"mod_reg1".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"mod_reg2\" value=\"".htmlspecialchars((string) ${"mod_reg2".$anno_modifica})."\">";
...
if (fix_set(${"ins_costi_agg".$anno_modifica}) == "s" and fixset(${"ins_costi_agg_gr".$anno_modifica}) == "SI") ${"ins_costi_agg".$anno_modifica} = "g";
if (substr($priv_ins_tariffe,1,1) != ${"ins_costi_agg".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"ins_costi_agg\" value=\"".htmlspecialchars((string) ${"ins_costi_agg".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"mod_costi_agg\" value=\"".htmlspecialchars((string) ${"mod_costi_agg".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"canc_costi_agg\" value=\"".htmlspecialchars((string) ${"canc_costi_agg".$anno_modifica})."\">";
...
if (fix_set(${"vedi_tab_mpren_gr".$anno_modifica}) == "SI") ${"vedi_tab_mesi".$anno_modifica} = "q";
if (fix_set(${"vedi_tab_mapp_gr".$anno_modifica}) == "SI") ${"vedi_tab_mesi".$anno_modifica} = "r";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_mesi\" value=\"".htmlspecialchars((string) ${"vedi_tab_mesi".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"oscura_tab_mesi\" value=\"".htmlspecialchars((string) ${"oscura_tab_mesi".$anno_modifica})."\">";
...
if (fix_set(${"vedi_tab_tutte_prenota".$anno_modifica}) == "p" and fixset(${"vedi_tab_tpren_gr".$anno_modifica}) == "SI") ${"vedi_tab_tutte_prenota".$anno_modifica} = "g";
if (substr($priv_vedi_tab,1,1) != ${"vedi_tab_tutte_prenota".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_tutte_prenota\" value=\"".htmlspecialchars((string) ${"vedi_tab_tutte_prenota".$anno_modifica})."\">";
...
if (fix_set(${"vedi_tab_costi".$anno_modifica}) == "p" and fixset(${"vedi_tab_cos_gr".$anno_modifica}) == "SI") ${"vedi_tab_costi".$anno_modifica} = "g";
if (substr($priv_vedi_tab,2,1) != ${"vedi_tab_costi".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_costi\" value=\"".htmlspecialchars((string) ${"vedi_tab_costi".$anno_modifica})."\">";
...
if (fix_set(${"vedi_tab_tariffe".$anno_modifica}) == "p" and fixset(${"vedi_tab_tar_gr".$anno_modifica}) == "SI") ${"vedi_tab_tariffe".$anno_modifica} = "g";
if (substr($priv_vedi_tab,3,1) != ${"vedi_tab_tariffe".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_tariffe\" value=\"".htmlspecialchars((string) ${"vedi_tab_tariffe".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_regole\" value=\"".htmlspecialchars((string) ${"vedi_tab_regole".$anno_modifica})."\">";
...
if (fix_set(${"vedi_tab_appartamenti".$anno_modifica}) == "p" and fixset(${"vedi_tab_app_gr".$anno_modifica}) == "SI") ${"vedi_tab_appartamenti".$anno_modifica} = "g";
if (substr($priv_vedi_tab,5,1) != ${"vedi_tab_appartamenti".$anno_modifica}) {
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_appartamenti\" value=\"".htmlspecialchars((string) ${"vedi_tab_appartamenti".$anno_modifica})."\">";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_doc\" value=\"".htmlspecialchars((string) ${"vedi_tab_doc".$anno_modifica})."\">";
...
if (fix_set(${"vedi_tab_spren_gr".$anno_modifica}) == "SI") ${"vedi_tab_stat".$anno_modifica} = "q";
if (fix_set(${"vedi_tab_sapp_gr".$anno_modifica}) == "SI") ${"vedi_tab_stat".$anno_modifica} = "r";
...
$dati_da_modificare .= "<input type=\"hidden\" name=\"vedi_tab_stat\" value=\"".htmlspecialchars((string) ${"vedi_tab_stat".$anno_modifica})."\">";
...
if (!empty($cambia_motivazioni_reg1)) $nuove_regole1_consentite = substr($nuove_regole1_consentite,0,3).htmlspecialchars($nuove_motivazioni_reg1,ENT_COMPAT);
...
$locale_mex = substr(strstr($lingua[$id_utente_privilegi],"-"),1);
$lingua_mex = str_replace("-$locale_mex","",$lingua[$id_utente_privilegi]);
