...
$var_pag[9] = 'aggiungi_tipologie';
$var_pag[10] = 'soprannome';
$var_pag[11] = 'sesso';
$var_pag[12] = 'nazionalita';
$var_pag[13] = 'lingua_cli';
$var_pag[14] = 'giornonascita';
$var_pag[15] = 'mesenascita';
$var_pag[16] = 'annonascita';
$var_pag[17] = 'nazionenascita';
$var_pag[18] = 'regionenascita';
$var_pag[19] = 'cittanascita';
$var_pag[20] = 'via';
$var_pag[21] = 'nomevia';
$var_pag[22] = 'numcivico';
$var_pag[23] = 'cap';
$var_pag[24] = 'nazione';
$var_pag[25] = 'regione';
$var_pag[26] = 'citta';
$var_pag[27] = 'documento';
$var_pag[28] = 'giornoscaddoc';
$var_pag[29] = 'mesescaddoc';
$var_pag[30] = 'annoscaddoc';
$var_pag[31] = 'nazionedoc';
$var_pag[32] = 'regionedoc';
$var_pag[33] = 'cittadoc';
$var_pag[34] = 'telefono';
$var_pag[35] = 'telefono2';
$var_pag[36] = 'telefono3';
$var_pag[37] = 'fax';
$var_pag[38] = 'email';
$var_pag[39] = 'email2';
$var_pag[40] = 'email_cert';
$var_pag[41] = 'cod_fiscale';
$var_pag[42] = 'partita_iva';
$var_pag[43] = 'inseriscicliente';
$var_pag[44] = 'titolo_cli';
$var_pag[45] = 'tipodoc';
$var_pag[46] = 'inserire';
$var_pag[47] = 'idclienti';
$var_pag[48] = 'id_utente_ins';
$var_pag[49] = 'id_transazione';
$var_pag[50] = 'datiprenota';
$var_pag[51] = 'idmessaggi';
$var_pag[52] = 'n_cli_esist_passa';
$var_pag[53] = 'n_campi_pers_passa';
$var_pag[54] = 'spezzetta_cont';
$var_pag[55] = 'prenota_vicine';
$var_pag[56] = 'idcognome_cp';
$var_pag[57] = 'idospiti_cp';
$n_var_pag = 58;
$num2 = 0;
...
$cognome = htmlspecialchars(fixstr($cognome),ENT_COMPAT);
$cognome2 = htmlspecialchars(fixstr($cognome2),ENT_COMPAT);
$nome = htmlspecialchars(fixstr($nome),ENT_COMPAT);
$soprannome = htmlspecialchars(fixstr($soprannome),ENT_COMPAT);
$titolo_cli = htmlspecialchars(fixstr($titolo_cli));
if (!empty($sesso) and $sesso != "f") $sesso = "m";
$giornonascita = htmlspecialchars(fixstr($giornonascita),ENT_COMPAT);
$mesenascita = htmlspecialchars(fixstr($mesenascita),ENT_COMPAT);
$annonascita = htmlspecialchars(fixstr($annonascita),ENT_COMPAT);
$documento = htmlspecialchars(fixstr($documento),ENT_COMPAT);
$giornoscaddoc = htmlspecialchars(fixstr($giornoscaddoc),ENT_COMPAT);
$mesescaddoc = htmlspecialchars(fixstr($mesescaddoc),ENT_COMPAT);
$annoscaddoc = htmlspecialchars(fixstr($annoscaddoc),ENT_COMPAT);
$tipodoc = htmlspecialchars(fixstr($tipodoc),ENT_COMPAT);
$cittadoc = htmlspecialchars(fixstr($cittadoc),ENT_COMPAT);
$regionedoc = htmlspecialchars(fixstr($regionedoc),ENT_COMPAT);
$nazionedoc = htmlspecialchars(fixstr($nazionedoc),ENT_COMPAT);
$cittanascita = htmlspecialchars(fixstr($cittanascita),ENT_COMPAT);
$regionenascita = htmlspecialchars(fixstr($regionenascita),ENT_COMPAT);
$nazionenascita = htmlspecialchars(fixstr($nazionenascita),ENT_COMPAT);
$nazionalita = htmlspecialchars(fixstr($nazionalita),ENT_COMPAT);
$lingua_cli = htmlspecialchars(fixstr($lingua_cli),ENT_COMPAT);
...
$nomevia = htmlspecialchars(fixstr($nomevia),ENT_COMPAT);
...
$email = htmlspecialchars(fixstr($email),ENT_COMPAT);
$email2 = htmlspecialchars(fixstr($email2),ENT_COMPAT);
$email_cert = htmlspecialchars(fixstr($email_cert),ENT_COMPAT);
$cod_fiscale = htmlspecialchars(fixstr($cod_fiscale),ENT_COMPAT);
$partita_iva = htmlspecialchars(fixstr($partita_iva),ENT_COMPAT);
#$origine = htmlspecialchars(fixstr($origine));
for ($num1 = 0 ; $num1 < $num_campi_pers ; $num1++) ${"campo_pers".$num1} = htmlspecialchars(fixstr(${"campo_pers".$num1}),ENT_COMPAT);
...
echo "<input type=\"hidden\" name=\"num_piano$n_t\" value=\"".htmlspecialchars(fixstr(${"num_piano".$n_t}))."\">
...
$idinizioperiodo = esegui_query("select idperiodi from $tableperiodi where datainizio = '".aggslashdb(fixset(${"inizioperiodo".$n_t}))."' ");
if (numlin_query($idinizioperiodo) == 1) ${"inizioperiodo".$n_t} = risul_query($idinizioperiodo,0,'idperiodi');
$idfineperiodo = esegui_query("select idperiodi from $tableperiodi where datafine = '".aggslashdb(fixset(${"fineperiodo".$n_t}))."' ");
...
$prenota_vicine_orig = $prenota_vicine;
$prenota_vicine = "";
$echo_dati_form = "NO";
include("./includes/dati_form_prenotazione.php");
$prenota_vicine = $prenota_vicine_orig;
unset($prenota_vicine_orig);
$echo_dati_form = "";
...
$maxoccupanti = $dati_app['maxocc'][$dati_app['posizione'][$num1]];
if (!$maxoccupanti) {
$max_maxoccupanti = 0;
break;
...
$num_app_reali_costo = array();
$diff_aggiungi_letti = array();
...
${"inizioperiodo".$n_t} = aggslashdb(fixset(${"inizioperiodo".$n_t}));
${"fineperiodo".$n_t} = aggslashdb(fixset(${"fineperiodo".$n_t}));
${"nometipotariffa".$n_t} = aggslashdb(fixset(${"nometipotariffa".$n_t}));
${"numpersone".$n_t} = aggslashdb(fixset(${"numpersone".$n_t}));
${"appartamento".$n_t} = htmlspecialchars(fixstr(${"appartamento".$n_t}),ENT_COMPAT);
${"appartamento".$n_t} = aggslashdb(${"appartamento".$n_t});
${"num_app_richiesti".$n_t} = aggslashdb(fixset(${"num_app_richiesti".$n_t}));
${"lista_app".$n_t} = htmlspecialchars(fixstr(${"lista_app".$n_t}),ENT_COMPAT);
${"lista_app".$n_t} = aggslashdb(${"lista_app".$n_t});
${"num_piano".$n_t} = aggslashdb(htmlspecialchars(fixstr(${"num_piano".$n_t})));
${"num_casa".$n_t} = aggslashdb(htmlspecialchars(fixstr(${"num_casa".$n_t})));
${"num_persone_casa".$n_t} = aggslashdb(fixset(${"num_persone_casa".$n_t}));
...
if (!$inizioperiodo or !strpos($dates_options_list,$inizioperiodo)) $data_sbagliata = "SI";
if (!$fineperiodo or !strpos($dates_options_list,$fineperiodo)) $data_sbagliata = "SI";
...
${"numpersone_orig".$n_t} = $numpersone_orig;
...
else $maxoccupanti = $numpersone_orig;
if ($maxoccupanti >= $numpersone) $napp_posti++;
} # fine if (isset($dati_app['maxocc'][$vett_app[$num1]]))
} # fine if for $num1
if ($napp_posti < $dati_r2['napp'][$tipotariffa]) {
$numpersone_nr[$n_t] = trova_numpersone_per_app($lista_app,$posti_mancanti[$n_t],$cat_pers_letto,$cat_persone[$n_t],$dati_app_pos,$dati_app,$dati_r2['napp'][$tipotariffa],$numpersone_orig,$dati_cat_pers);
$posti_mancanti['cat_pers_letto'][$n_t] = $cat_pers_letto;
if ($cat_pers_letto >= 0) ${"cat$cat_pers_letto"."_numpers$n_t"} = $cat_persone[$n_t][$cat_persone[$n_t]['ord'][$cat_pers_letto]]['molt'];
...
if (${"diff_persone".$n_t} and ($num1 + ${"diff_persone".$n_t}) >= $dati_r2['napp'][$tipotariffa] and !isset($numpersone_nr[$n_t][$num1])) $numpersone_nr[$n_t][$num1] = $numpersone - 1;
...
if (isset($cat_persone_copia['ord'][$num2]) and !empty($cat_persone_copia[$cat_persone_copia['ord'][$num2]]['molt']) and $numpersone_cp) {
...
} # fine if (isset($cat_persone_copia['ord'][$num2]) and !empty($cat_persone_copia[$cat_persone_copia['ord'][$num2]]['molt']) and...
} # fine for $num2
for ($num2 = ($num1 + $dati_r2['napp'][$tipotariffa]) ; $num2 < ($num_app_richiesti * $dati_r2['napp'][$tipotariffa]) ; $num2 += $dati_r2['napp'][$tipotariffa]) {
if (strcmp(fixstr($numpersone_nr[$n_t][$num1]),"")) $numpersone_nr[$n_t][$num2] = $numpersone_nr[$n_t][$num1];
...
$posti_mancanti[$n_t] = ($posti_mancanti[$n_t] * $num_app_richiesti);
...
if (!${"prenota_vicine".$n_t} and $prenota_vicine != "SI" and !empty($dati_r2['napp']['v'][$tipotariffa])) ${"interrompi_vicine_ogni".$n_t} = $dati_r2['napp'][$tipotariffa];
...
$appartamento_esistente = esegui_query("select idappartamenti from $tableappartamenti where idappartamenti = '".aggslashdb($appo)."'");
if (numlin_query($appartamento_esistente) != 1) {
$inserire = "NO";
echo mex("L'appartamento",'unit.php')." <div style=\"display: inline; color: red;\">".htmlspecialchars($appo)."</div> ".mex("contenuto nella lista non esiste",'unit.php');
if ($num_tipologie > 1) echo " (".mex("tipologia",$pag)." $n_t)";
echo ".<br>";
...
if ($max_maxoccupanti_corr < 0 or !$maxoccupanti  or ($max_maxoccupanti_corr and $maxoccupanti > $max_maxoccupanti_corr)) $max_maxoccupanti_corr = $maxoccupanti;
...
$num_posto_max = -1;
$numpers_posto_max = 0;
for ($num2 = 0 ; $num2 < $num_app_richiesti ; $num2++) {
...
if ($posti_mancanti[$n_t]) $posti = ($num_app_richiesti - 1);
...
if ($priv_ins_costi_agg == "s" and ($attiva_costi_agg_consentiti == "n" or (isset($costi_agg_consentiti_vett[$dati_ca[$num1]['id']]) and $costi_agg_consentiti_vett[$dati_ca[$num1]['id']] == "SI"))) {
for ($numca = 1 ; $numca <= $numcostiagg ; $numca++) {
...
if ($dati_ca[$num1]['moltiplica'] == "c" and $max_maxoccupanti_corr and $numpersone > $max_maxoccupanti_corr) {
$num_aggiungi_letti = $numpersone - $max_maxoccupanti_corr;
if ($dati_ca[$num1]['molt_max'] == "n" and $num_aggiungi_letti > $dati_ca[$num1]['molt_max_num']) $num_aggiungi_letti = $dati_ca[$num1]['molt_max_num'];
} # fine if ($dati_ca[$num1]['moltiplica'] == "c" and $max_maxoccupanti_corr and $numpersone > $max_maxoccupanti_corr)
...
if ($posti_mancanti['cat_pers_letto'][$n_t] >= 0) $cat_pers_letto = $posti_mancanti['cat_pers_letto'][$n_t];
elseif ($posti_mancanti['cat_pers_letto'][$n_t] < -1) $diminuiti_lettiagg_per_catpers = $posti_mancanti[$n_t];
...
if (!empty(${"numpersone_orig".$n_t})) $num_aggiungi_letti_corr = ($num_aggiungi_letti * $dati_r2['napp'][$tipotariffa]);
...
} # fine else if ($posti_mancanti[$n_t])
} # fine if ($dati_cat_pers['num'])
...
if ($posti_mancanti[$n_t]) $posti_mancanti['idcal'][$n_t] = $costo_aggiungi_letti;
...
if (empty($app_richiesti_copia) or $app_richiesti_copia[$idapp] == "SI") {
if ((($maxoccupanti and $maxoccupanti < $numpersone) or str_replace(",$idapp,","",",$app_incomp_cal,") != ",$app_incomp_cal," or $risul_beniinv != "SI") and !$posti_mancanti[$n_t]) ${"app_richiesti".$n_t}[$idapp] = "NO";
else {
${"app_richiesti".$n_t}[$idapp] = "SI";
$posti++;
if ($posti_mancanti[$n_t]) {
if (str_replace(",$idapp,","",",$app_incomp_cal,") == ",$app_incomp_cal," and $risul_beniinv == "SI") $posti_comp++;
else $posti_mancanti['app_incomp_cal'][$n_t][$idapp] = 1;
} # fine ($posti_mancanti[$n_t])
...
if ($posti_mancanti[$n_t]) {
$posto_trovato = 0;
if (!$diminuiti_lettiagg_per_catpers) {
# Provo ad eliminare gli appartamenti incompatibili da quelli richiesti per le tipologie necessarie, se sufficienti
if ($posti_comp > $num_app_richiesti) $posti_max = $num_app_richiesti;
else $posti_max = $posti_comp;
if ($posti_mancanti[$n_t] <= ($posti_max * $num_aggiungi_letti)) {
$num_elim = 0;
$app_usati = array();
for ($num2 = 0 ; $num2 < $num_app_richiesti ; $num2++) {
if (($num_elim * $num_aggiungi_letti) < $posti_mancanti[$n_t]) {
$app_richiesti_orig = $app_richiesti_nr[$n_t][$num2];
$app_trovato = 0;
foreach ($app_richiesti_orig as $idapp => $val) {
if (!empty($posti_mancanti['app_incomp_cal'][$n_t][$idapp])) $app_richiesti_nr[$n_t][$num2][$idapp] = "";
elseif (!$app_trovato and !isset($app_usati[$idapp])) {
$app_usati[$idapp] = 1;
$app_trovato = 1;
} # fine elseif (!$app_trovato and !isset($app_usati[$idapp])
} # fine foreach ($app_richiesti_orig as $idapp => $val)
if ($app_trovato) $num_elim++;
else $app_richiesti_nr[$n_t][$num2] = $app_richiesti_orig;
} # fine if (($num_elim * $num_aggiungi_letti) < $posti_mancanti[$n_t])
} # fine for $num2
if ($posti_mancanti[$n_t] <= ($num_elim * $num_aggiungi_letti)) $posto_trovato = 1;
} # fine if ($posti_mancanti[$n_t] <= ($posti_max * $num_aggiungi_letti))
} # fine if (!$diminuiti_lettiagg_per_catpers)
if (!$posto_trovato) $posti = ($num_app_richiesti - 1);
} # fine if ($posti_mancanti[$n_t])
...
if (!empty(${"numpersone_orig".$n_t})) {
if ($posti_mancanti[$n_t]) $numpersone_orig = (int) ${"numpersone_orig".$n_t} - $posti_mancanti[$n_t];
else $numpersone_orig = (int) $numpersone * $dati_r2['napp'][$tipotariffa];
# Se c'è una sola persona aggiuntiva applico il costo solo alle prime prenotazioni, altrimenti poi ne diminuisco il numero per cui è moltiplicato
if ($num_aggiungi_letti == 1) $num_app_reali_costo[$n_t][$costo_aggiungi_letti] = (${"numpersone_orig".$n_t} - $numpersone_orig) * 1;
else $diff_aggiungi_letti[$n_t][$costo_aggiungi_letti] = (${"numpersone_orig".$n_t} - $numpersone_orig - (($num_aggiungi_letti - 1) * $dati_r2['napp'][$tipotariffa])) * 1;
${"numpersone_orig".$n_t} = $numpersone_orig;
} # fine if (!empty(${"numpersone_orig".$n_t}))
...
if ($app_incomp_cal) {
if ($posti_mancanti[$n_t]) {
$posti_mancanti['no_cal'][$n_t]['lista_app'] = ${"lista_app".$n_t};
$posti_mancanti['no_cal'][$n_t]['app_eliminati_costi'] = $app_eliminati_costi;
$posti_mancanti['no_cal'][$n_t]['assegnazioneapp'] = ${"assegnazioneapp".$n_t};
} # fine if ($posti_mancanti[$n_t])
...
if (!empty($costo_aggiungi_letti)) break;
...
if ($posti < $num_app_richiesti) {
if (${"numpersone_orig".$n_t}) $numpersone_corr = ${"numpersone_orig".$n_t};
else $numpersone_corr = $numpersone;
echo mex("Non ci sono",'unit.php')." $num_app_richiesti ".mex("appartamenti tra quelli richiesti che possano ospitare",'unit.php')." $numpersone_corr ".mex("persone",$pag);
if (!empty($lista_costi_app_incomp[$n_t])) echo " ".mex("con i costi aggiuntivi selezionati",$pag)." (".substr($lista_costi_app_incomp[$n_t],0,-2).")";
if (!empty($costo_aggiungi_letti) and $dati_cat_pers['num'] and $diminuiti_lettiagg_per_catpers) echo " (".mex("non si sono potuti usare",$pag)." $diminuiti_lettiagg_per_catpers ".mex("letti aggiuntivi perchè non c'era nessuna tipologia di persone con quel numero",$pag).")";
if ($num_tipologie > 1) echo " (".mex("tipologia",$pag)." $n_t)";
echo ".<br>";
...
if ($inserire == "NO" and $app_richiesti_copia) ${"app_richiesti".$n_t} = $app_richiesti_copia;
} # fine else if (controlla_num_pos($numpersone) == "NO")
} # fine if ($numpersone)
...
for ($num1 = 0 ; $num1 < $num_app_richiesti ; $num1++) {
$id_app_richiesti++;
...
for ($n_t = 1 ; $n_t <= $num_tipologie ; $n_t++) {
if (!empty($lista_costi_app_incomp[$n_t])) {
echo " ".mex("con i costi aggiuntivi selezionati",$pag)." (".substr($lista_costi_app_incomp[$n_t],0,-2).")";
break;
} # fine if (!empty($lista_costi_app_incomp[$n_t]))
} # fine for $n_t
echo ".<br>";
if ($occupare_app_agenzia_sempre == "SI" and (!isset($app_richiesti) or !is_array($app_richiesti) or empty($app_richiesti[',numero,']))) {
echo mex("Si dovrà occupare almeno un periodo della regola di assegnazione 1",$pag).".<br>";
} # fine if ($occupare_app_agenzia_sempre == "SI" and (!isset($app_richiesti) or...
...
if (strcmp($cognome2_camb,"")) $cliente_camb .= " $cognome2_camb";
...
if ($motivazione_app_agenzia) $motivazione_app_ag = " (<b>$motivazione_app_agenzia</b>)";
else $motivazione_app_ag = "";
echo mex("La nuova prenotazione verrà inserita nell'appartamento",'unit.php')." <b class=\"colblu\">$id_app_agenzia</b>$motivazione_app_ag.<br>";
...
# la lista di appartamenti può avere caratteri UTF8 e venire tagliata in modo errato da substr (anche se i primi/unltimi caratteri non sono UTF8?)
if ($n_t != 1) $dati_transazione4 .= ", ,";
...
$dati_transazione4 = aggslashdb($dati_transazione4);
...
$dati_cal = array('num_app_reali_costo' => $num_app_reali_costo, 'diff_aggiungi_letti' => $diff_aggiungi_letti, 'posti_mancanti' => $posti_mancanti);
$dati_transazione22 = aggslashdb(serialize($dati_cal));
...
if ($num_spostamenti == 1) $num_spostamenti = 0;
...
for ($num2 = $inizio_prenota_id[$idprenota_cambiata] ; $num2 <= $fine_prenota_id[$idprenota_cambiata] ; $num2++) {
if (!empty($prenota_in_app_sett[$app_cambiato][$num2])) $inserire = "NO";
...
if (!empty($prenota_in_app_sett[$appartamento[$num1]][$num2])) $inserire = "NO";
} # fine for $num2
} # fine for $num1
} # fine for $n_t
...
if ($vedi_clienti == "GRUPPI" or (empty($nuovaprenotazione) and $modifica_clienti == "GRUPPI")) {
...
if (!$secondo_cognome or !strcmp($cognome2,"")) {
...
} # fine if (!$secondo_cognome or !strcmp($cognome2,""))
else {
if (!$nome) $esistecognome = esegui_query("select * from $tableclienti where ( cognome $ILIKE '%".aggslashdb($cognome)."%' and (cognome $ILIKE '%".aggslashdb($cognome2)."%' or cognome2 $ILIKE '%".aggslashdb($cognome2)."%')) $condizione_utente order by max_num_ordine");
else $esistecognome = esegui_query("select * from $tableclienti where ( cognome $ILIKE '%".aggslashdb($cognome)."%' and (cognome $ILIKE '%".aggslashdb($cognome2)."%' or cognome2 $ILIKE '%".aggslashdb($cognome2)."%') and nome $ILIKE '%".aggslashdb($nome)."%' ) $condizione_utente order by max_num_ordine");
} # fine else if (!$secondo_cognome or !strcmp($cognome2,""))
...
if ($secondo_cognome and strcmp($cognome2,"")) echo " $cognome2";
if ($nome) echo " $nome";
echo ".<br>";
$inserire = "NO";
...
mostra_dati_cliente($dati,$dcognome,$dcognome2,$dnome,$dsoprannome,$dtitolo_cli,$dsesso,$ddatanascita,$ddatanascita_f,$dnazionenascita,$dcittanascita,$dregionenascita,$ddocumento,$dscadenzadoc,$dscadenzadoc_f,$dtipodoc,$dnazionedoc,$dregionedoc,$dcittadoc,$dnazionalita,$dlingua_cli,$dnazione,$dregione,$dcitta,$dvia,$dnumcivico,$dtelefono,$dtelefono2,$dtelefono3,$dfax,$dcap,$demail,$demail2,$demail_cert,$dcod_fiscale,$dpartita_iva,"SI",$priv_ins_clienti,0,1);
echo "<br>";
...
$cccognome2 = addslashes((string) risul_query($clienti_compagni,$num1,'cognome2'));
...
if (controlla_num_pos($idclienti) == "SI") {
$dati_cliente = esegui_query("select cognome,cognome2,utente_inserimento from $tableclienti where idclienti = '$idclienti'");
if (numlin_query($dati_cliente)) {
$cognome = risul_query($dati_cliente,0,'cognome');
$cognome2 = risul_query($dati_cliente,0,'cognome2');
if ($cognome2) $cognome .= " $cognome2";
...
} # fine if (controlla_num_pos($idclienti) == "SI")
else $inserire = "NO";
...
echo ",</span> ";
if ($secondo_cognome) echo "<span class=\"wsnw\">".mex("2° cognome",$pag).": <input type=\"text\" id=\"cognome2\" name=\"cognome2\" value=\"$cognome2_mostra\">,</span><br>";
echo "<span class=\"wsnw\">".mex("nome",$pag).": <input type=\"text\" name=\"nome\" value=\"$nome_mostra\">;</span>
...
if ($ini_lingua == str_replace(strstr($lingua[$id_utente],"-"),"",$lingua[$id_utente])) $opt_lingue = "<option value=\"$ini_lingua\"$sel>".ucfirst($nome_lingua)."</option>".$opt_lingue;
...
if ($secondo_cognome) echo " ".addslashes("<span class=\"wsnw\">".mex("2° cognome",$pag)).": <input type=\"text\" id=\"cognome2'+suff+'\" name=\"cognome2'+suff+'\"><input type=\"button\" class=\"cpbutton\" onclick=\"cp_val(\'cognome2'+suff+'\',\'cognome2'+suffcp+'\',\'\')\" value=\"#\">,<\/span>";
echo " ".addslashes("<span class=\"wsnw\">".mex("nome",$pag)).": <input type=\"text\" name=\"nome'+suff+'\">;<\/span><br>\
