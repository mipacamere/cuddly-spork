...
$cerca_inizioperiodo = htmlspecialchars($cerca_anno_inizioperiodo.$cerca_inizioperiodo,ENT_COMPAT);
...
$cerca_fineperiodo = htmlspecialchars($cerca_anno_fineperiodo.$cerca_fineperiodo,ENT_COMPAT);
...
if ($priv_mod_prenotazioni == "g" and empty($utenti_gruppi[$utente_ins_pren])) $link_modifica = 0;
