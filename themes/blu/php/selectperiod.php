...
if (!empty($date_selected)) echo $doc_write_parentesis."opz.replace(\"".htmlspecialchars((string) $date_selected)."\\\">\",\"".htmlspecialchars((string) $date_selected)."\\\" selected>\")$close_parentesis;";
