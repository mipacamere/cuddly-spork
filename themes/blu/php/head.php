...
##################################################################################
#    HOTELDRUID
#    Copyright (C) 2001-2024 by Marco Maria Francesco De Santis (marco@digitaldruid.net)
#
...
<html lang=\"".substr($lingua_mex,0,2)."\">
<head>
...
";
#if (defined('C_URL_MANIFEST') and C_URL_MANIFEST != "" and @is_file(C_URL_MANIFEST)) echo "<link rel=\"manifest\" href=\"".C_URL_MANIFEST."\">
#";
#elseif (!defined('C_NASCONDI_MARCA') or C_NASCONDI_MARCA != "SI") echo "<link rel=\"manifest\" href=\"./themes/$tema_corr/inc/manifest.json\">
#";
