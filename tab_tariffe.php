...
if (!isset(${"numtariffa".$num1}) or ${"numtariffa".$num1} < 1 or ${"numtariffa".$num1} > $numero_tariffe or controlla_num_pos(${"numtariffa".$num1}) != "SI") {
if ($num1 == 1) ${"numtariffa".$num1} = 1;
else $num_tariffe_mostra = 1;
} # fine if (!isset(${"numtariffa".$num1}) or ${"numtariffa".$num1} < 1 or ${"numtariffa".$num1} > $numero_tariffe or...
} # fine for $num1
...
$n_descrizione_ita = aggslashdb(htmlspecialchars($n_descrizione_ita,ENT_COMPAT));
...
$n_descrizione = aggslashdb(htmlspecialchars($n_descrizione,ENT_COMPAT));
...
$n_urlfoto = trim(fixstr($n_urlfoto));
...
if (substr($lowurl,0,5) != "http:" and substr($lowurl,0,6) != "https:" and preg_match("/^[a-z ]+:/i",$n_urlfoto)) $errore = "SI";
if ($errore != "SI") {
$tabelle_lock = array($tabledescrizioni);
$tabelle_lock = lock_tabelle($tabelle_lock);
...
$n_commento_ita = aggslashdb(htmlspecialchars($n_commento_ita,ENT_COMPAT));
...
$n_commento = aggslashdb(htmlspecialchars($n_commento,ENT_COMPAT));
...
if (($priv_vedi_tab_periodi == "s" and $priv_vedi_tab_regole == "s" and $priv_vedi_tab_mesi == "s") or $attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[${"numtariffa".$num1}]) and $tariffe_consentite_vett[${"numtariffa".$num1}] == "SI")) {
...
} # fine if (($priv_vedi_tab_periodi == "s" and $priv_vedi_tab_regole == "s" and $priv_vedi_tab_mesi == "s") or $attiva_tariffe_consentite == "n" or...
} # fine for $num1
...
for ($num1 = 1 ; $num1 <= $num_tariffe_mostra ; $num1++) {
if ($priv_vedi_tab_periodi == "s" or $attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[${"numtariffa".$num1}]) and $tariffe_consentite_vett[${"numtariffa".$num1}] == "SI")) {
...
if (empty($form_tabella)) $tar_corr = (string) ((float) $tar_corr * (float) $dati_r2['napp'][$tariffa[$num1]]);
#$tarp_corr = (string) ((float) $tarp_corr * (float) $dati_r2['napp'][$tariffa[$num1]]);
...
if ($mostra_disp == "s") $liberi_colonna_periodo[$num1][0] = fixset($tab_liberi[$tariffa[$num1]][$idper_corr]);
...
$tariffa_colonna_periodo[$num1][0] += (float) $tar_corr;
$tariffap_colonna_periodo[$num1][0] += (float) $tarp_corr;
...
if ($mostra_disp == "s" and fixset($tab_liberi[$tariffa[$num1]][$idper_corr]) < $liberi_colonna_periodo[$num1][0]) $liberi_colonna_periodo[$num1][0] = $tab_liberi[$tariffa[$num1]][$idper_corr];
...
if ($priv_vedi_tab_periodi == "s" or $attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[${"numtariffa".$num2}]) and $tariffe_consentite_vett[${"numtariffa".$num2}] == "SI")) {
...
if (empty($form_tabella)) $tar_corr = (string) ((float) $tar_corr * (float) $dati_r2['napp'][$tariffa[$num2]]);
#$tarp_corr = (string) ((float) $tarp_corr * (float) $dati_r2['napp'][$tariffa[$num2]]);
...
${$tariffa[$num2]."c"} = "";
${$tariffa[$num2]."i"} = "";
if ($mostra_disp == "s") ${$tariffa[$num2]."l"} = fixset($tab_liberi[$tariffa[$num2]][$idper_corr]);
...
${$tariffa[$num2]} += (float) $tar_corr;
${$tariffa[$num2]."p"} += (float) $tarp_corr;
...
if ($mostra_disp == "s" and fixset($tab_liberi[$tariffa[$num2]][$idper_corr]) < ${$tariffa[$num2]."l"}) ${$tariffa[$num2]."l"} = $tab_liberi[$tariffa[$num2]][$idper_corr];
...
} # fine if ($priv_vedi_tab_periodi == "s" or $attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[${"numtariffa".$num2}]) and...
} # fine for $num2
$nuova_colonna = "NO";
...
$tab_modificabile = 0;
for ($num1 = 1 ; $num1 <= $num_tariffe_mostra ; $num1++) {
if (empty($dati_tariffe[$tariffa[$num1]]['importa_prezzi'][0]) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and $tariffe_consentite_vett_ut[${"numtariffa".$num1}] == "SI"))) $tab_modificabile = 1;
if ($mostra_pmm == "s" and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and $tariffe_consentite_vett_ut[${"numtariffa".$num1}] == "SI")) and $priv_ins_costi_agg != "n" and $priv_mod_costo_agg != "n" and $priv_canc_costi_agg != "n") $tab_modificabile = 1;
echo "<input type=\"hidden\" name=\"numtariffa$num1\" value=\"".${"numtariffa".$num1}."\">
...
if (!empty($form_tabella) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and $tariffe_consentite_vett_ut[${"numtariffa".$num1}] == "SI")) and !$importata_colonna_periodo[$num1][$num2]) {
...
} # fine if (!empty($form_tabella) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and...
else {
...
} # fine else if (!empty($form_tabella) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and...
if ($chiusa_colonna_periodo[$num1][$num2]) $style = " style=\"background-color: #777777;\"";
else $style = "";
if (empty($form_tabella) and empty($dati_tariffe[$tariffa[$num1]]['importa_prezzi'][0]) and empty($importata_colonna_periodo[$num1][$num2]) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and $tariffe_consentite_vett_ut[${"numtariffa".$num1}] == "SI"))) $id_td = " id=\"per".$per_colonna_periodo[$num2]."tar".${"numtariffa".$num1}."\"";
else $id_td = "";
echo "<td$id_td align=\"center\"$style>$tariffa_vedi</td>";
} # fine if (!empty($mostra_data[$num2]))
} # fine for $num2
echo "</tr>";
if ($mostra_disp == "s" and (($priv_vedi_tab_periodi == "s" and $priv_vedi_tab_regole == "s" and $priv_vedi_tab_mesi == "s") or $attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[${"numtariffa".$num1}]) and $tariffe_consentite_vett[${"numtariffa".$num1}] == "SI"))) {
...
for ($num2 = 0 ; $num2 <= $num_colonne_periodi ; $num2++) {
if (!empty($mostra_data[$num2])) {
if (!empty($form_tabella) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and $tariffe_consentite_vett_ut[${"numtariffa".$num1}] == "SI")) and $priv_ins_costi_agg != "n" and $priv_mod_costo_agg != "n" and $priv_canc_costi_agg != "n") {
...
if (empty($form_tabella) and ($attiva_tariffe_consentite_ut == "n" or (isset($tariffe_consentite_vett_ut[${"numtariffa".$num1}]) and $tariffe_consentite_vett_ut[${"numtariffa".$num1}] == "SI"))) $id_td = " id=\"per".$per_colonna_periodo[$num2]."tar".${"numtariffa".$num1}."pmin\"";
else $id_td = "";
...
if ($attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[$numtariffa1]) and $tariffe_consentite_vett[$numtariffa1] == "SI")) {
...
echo "</div></div>";
} # fine if ($attiva_tariffe_consentite == "n" or (isset($tariffe_consentite_vett[$numtariffa1]) and...
