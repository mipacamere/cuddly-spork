...
$n_var_pag = 4;
$num2 = 0;
if (isset($_POST['id_prenota'])) $num2 = $_POST['id_prenota'];
elseif (isset($_GET['id_prenota'])) $num2 = $_GET['id_prenota'];
if ($num2) {
$num7 = explode(",",$num2);
$num8 = count($num7);
...
$var_pag[$n_var_pag++] = "principale$num2";
$var_pag[$n_var_pag++] = "nazione$num2"."_1";
$var_pag[$n_var_pag++] = "regione$num2"."_1";
$var_pag[$n_var_pag++] = "citta$num2"."_1";
$var_pag[$n_var_pag++] = "documento$num2"."_1";
$var_pag[$n_var_pag++] = "tipodoc$num2"."_1";
$var_pag[$n_var_pag++] = "giornoscaddoc$num2"."_1";
$var_pag[$n_var_pag++] = "mesescaddoc$num2"."_1";
$var_pag[$n_var_pag++] = "annoscaddoc$num2"."_1";
$var_pag[$n_var_pag++] = "nazionedoc$num2"."_1";
$var_pag[$n_var_pag++] = "regionedoc$num2"."_1";
$var_pag[$n_var_pag++] = "cittadoc$num2"."_1";
$var_pag[$n_var_pag++] = "id_osp_num$num2"."_0";
$var_pag[$n_var_pag++] = "num_altri_ospiti_passa$num2";
$num4 = 0;
if (isset($_POST["id_osp_num$num2"."_0"])) $num4 = (int) $_POST["id_osp_num$num2"."_0"];
elseif (isset($_GET["id_osp_num$num2"."_0"])) $num4 = (int) $_GET["id_osp_num$num2"."_0"];
if ($num4) $var_pag[$n_var_pag++] = "cliente_ospite$num2"."_$num4";
$num3 = 0;
...
$var_pag[$n_var_pag++] = "cognome2_$num2"."_$num1";
...
$num3 = 0;
if (isset($_POST["num_altri_ospiti_passa$num2"])) $num3 = (int) $_POST["num_altri_ospiti_passa$num2"];
elseif (isset($_GET["num_altri_ospiti_passa$num2"])) $num3 = (int) $_GET["num_altri_ospiti_passa$num2"];
for ($num1 = 0 ; $num1 < $num3 ; $num1++) {
$var_pag[$n_var_pag++] = "id_altro_osp_num$num2"."_$num1";
$num4 = 0;
if (isset($_POST["id_altro_osp_num$num2"."_$num1"])) $num4 = (int) $_POST["id_altro_osp_num$num2"."_$num1"];
elseif (isset($_GET["id_altro_osp_num$num2"."_$num1"])) $num4 = (int) $_GET["id_altro_osp_num$num2"."_$num1"];
if ($num4) $var_pag[$n_var_pag++] = "altro_ospite$num2"."_$num4";
} # fine for $num1
} # fine for $num6
} # fine if ($num2)
...
$id_prenota = aggslashdb(fixset($id_prenota));
...
$idclienti_compagni = "";
$num_ospiti = 0;
if (isset(${"cliente_ospite".$id_prenota."_".$idclienti}) and ${"cliente_ospite".$id_prenota."_".$idclienti} == "SI") {
$num_ospiti++;
...
$titolare_non_ospite = "";
} # fine if (isset(${"cliente_ospite".$id_prenota."_".$idclienti}) and ${"cliente_ospite".$id_prenota."_".$idclienti} == "SI")
else {
if (isset(${"id_osp_num".$id_prenota."_1"}) and ${"id_osp_num".$id_prenota."_1"} == $idclienti) esegui_query("delete from $tablerclientiprenota where idprenota = '$id_prenota' and idclienti = '$idclienti' ");
$titolare_non_ospite = $idclienti;
} # fine else if (isset(${"cliente_ospite".$id_prenota."_".$idclienti}) and...
...
if (!empty($osp_presente[$principale]) and isset(${"ospite".$id_prenota."_".$principale}) and ${"ospite".$id_prenota."_".$principale} == "SI") {
...
} # fine if (!empty($osp_presente[$principale]) and isset(${"ospite".$id_prenota."_".$principale}) and...
else $principale = "";
...
$parentela = fixstr(${"parentela_".$id_prenota."_".$id_clienti_osp});
if (@get_magic_quotes_gpc()) $parentela = stripslashes($parentela);
$parentela = htmlspecialchars(fixstr($parentela),ENT_COMPAT);
...
$cognome2_aux = fixset(${"cognome2_".$id_prenota."_".$num1});
...
$parentela = htmlspecialchars(fixstr($n_parentela[$num1]),ENT_COMPAT);
} # fine if ($n_num_ordine > 2)
else $parentela = "";
esegui_query("insert into $tablerclientiprenota (idprenota,idclienti,num_ordine,parentela,datainserimento,hostinserimento,utente_inserimento) values ('$id_prenota','$id_clienti_osp','$n_num_ordine','".aggslashdb($parentela)."','$datainserimento','$HOSTNAME','$id_utente_ins') ");
...
if ($titolare_non_ospite and $num1 == 1 and str_replace(",$titolare_non_ospite,","",$n_idclienti_compagni) == $n_idclienti_compagni) {
$n_idclienti_compagni .= "$titolare_non_ospite,";
esegui_query("update $tableclienti set idclienti_compagni = '$compagni_cliente"."$id_clienti_osp,' where idclienti = '$idclienti'");
} # fine if ($titolare_non_ospite and $num1 == 1)
...
else echo "<br><input type=\"hidden\" name=\"id_osp_num$id_prenota"."_0\" value=\"$idclienti\">
<label><input name=\"cliente_ospite".$id_prenota."_".$idclienti."\" value=\"SI\" type=\"checkbox\"> ".mex("Ospite della prenotazione",$pag)."</label><br>";
} # fine if ($num1 == 0)
if ($mostra_osp == "SI") {
...
else mostra_dati_cliente($dati_ospite,$dcognome,$dcognome2,$dnome,$dsoprannome,$dtitolo_cli,$dsesso,$ddatanascita,$ddatanascita_f,$dnazionenascita,$dcittanascita,$dregionenascita,$ddocumento,$dscadenzadoc,$dscadenzadoc_f,$dtipodoc,$dnazionedoc,$dregionedoc,$dcittadoc,$dnazionalita,$dlingua_cli,$dnazione,$dregione,$dcitta,$dvia,$dnumcivico,$dtelefono,$dtelefono2,$dtelefono3,$dfax,$dcap,$demail,$demail2,$demail_cert,$dcod_fiscale,$dpartita_iva,"",$priv_ins_clienti);
echo "</label>";
if ($num1 == 0) {
$checked = " checked";
$cognome_def = $dcognome;
...
if (!isset($cliente_ospite) or $cliente_ospite != "SI") echo "<br><input name=\"principale$id_prenota\" value=\"$id_clienti_osp\" type=\"radio\"$checked>".mex("Ospite principale",$pag)." ";
...
if ($num_ospiti == 0) {
echo "<br><input type=\"hidden\" name=\"id_osp_num$id_prenota"."_0\" value=\"$idclienti\">
<label><input name=\"cliente_ospite".$id_prenota."_".$idclienti."\" value=\"SI\" type=\"checkbox\"> ".mex("Ospite della prenotazione",$pag)."</label><br>";
...
if ($secondo_cognome) echo " ".mex("2° cognome",$pag).": <input type=\"text\" id=\"cognome2_$id_prenota"."_$n_o\" name=\"cognome2_$id_prenota"."_$n_o\"><input type=\"button\" class=\"cpbutton\" onclick=\"cp_val('cognome2_$id_prenota"."_$n_o','cognome2_$id_prenota"."_$n_ini','$cognome_def')\" value=\"#\">,";
echo " <span class=\"wsnw\">".mex("nome",$pag).": <input type=\"text\" name=\"nome$id_prenota"."_$n_o\">;</span>";
if ($secondo_cognome) echo "<br>";
echo "<span class=\"wsnw\">".mex("sesso",$pag).": <select name=\"sesso$id_prenota"."_$n_o\">
<option value=\"\" selected>-</option>
<option value=\"m\">m</option>
<option value=\"f\">f</option>
</select>;</span>";
if (!$secondo_cognome) echo "<br>";
echo "<span class=\"wsnw\">".mex("cittadinanza",$pag).": ".mostra_lista_relutenti("nazionalita$id_prenota"."_$n_o","",$id_utente,"nome_nazione","idnazioni","idnazione",$tablenazioni,$tablerelutenti)."<input type=\"button\" class=\"cpbutton\" onclick=\"cp_val('nazionalita$id_prenota"."_$n_o','nazionalita$id_prenota"."_$n_ini','$nazione_def')\" value=\"#\">;</span>
...
$presente_id[$id_clienti_osp] = "SI";
$dati_ospite = esegui_query("select cognome,cognome2,nome,sesso,datanascita,utente_inserimento from $tableclienti where idclienti = '$id_clienti_osp' ");
$dati_osp .= "<label><input name=\"altro_ospite$id_prenota"."_$id_clienti_osp\" value=\"SI\" type=\"checkbox\"><input type=\"hidden\" name=\"id_altro_osp_num$id_prenota"."_$num1\" value=\"$id_clienti_osp\">\
...
if ($dati_osp) {
echo "<input type=\"hidden\" name=\"num_altri_ospiti_passa$id_prenota\" value=\"$num_idclienti_compagni\">
