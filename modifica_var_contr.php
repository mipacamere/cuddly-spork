...
if ($attiva_contratti_consentiti != "n" and (!isset($contratti_consentiti_vett[$contr_cond]) or $contratti_consentiti_vett[$contr_cond] != "SI")) $contr_cond = "";
...
if (!empty($solo_contr_cond) and strcmp((string) $contr_cond,"")) {
$tipo = "var$contr_cond";
...
} # fine if (!empty($solo_contr_cond) and strcmp((string) $contr_cond,""))
else $tipo = "var";
if ($continua == "SI") {
...
$solo_contr_cond = "";
$tipo = "vett";
} # fine else if (!empty($solo_contr_cond) and strcmp((string) $contr_cond,""))
if ($continua == "SI") {
...
if ($contr_imp == $contr_cond or ($attiva_contratti_consentiti != "n" and (!isset($contratti_consentiti_vett[$contr_imp]) or $contratti_consentiti_vett[$contr_imp] != "SI"))) $contr_imp = "";
...
if (!isset($tipo_contr_imp) or $tipo_contr_imp != "importa") {
...
} # fine if (!isset($tipo_contr_imp) or $tipo_contr_imp != "importa")
else {
...
} # fine else if (!isset($tipo_contr_imp) or $tipo_contr_imp != "importa")
} # fine if ($contr_imp)
} # fine if ($contr_imp)
...
} # fine if ($attiva_contratti_consentiti == "n" or (isset($contratti_consentiti_vett[$num_contr]) and $contratti_consentiti_vett[$num_contr] == "SI"))
} # fine for $num1
echo "<br><form accept-charset=\"utf-8\" method=\"post\" action=\"$pag\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
...
if ($num1 == $num_cond_rpt and $condizione[0] == "ros") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni degli ospiti",$pag)." [r2]...[/r2] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_o and $condizione[0] == "rca") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dei costi aggiuntivi",$pag)." [r3]...[/r3] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_c and $condizione[0] == "rpa") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dei pagamenti",$pag)." [r5]...[/r5] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_p and $condizione[0] == "run") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni delle unità",$pag)." [r6]...[/r6] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_u and $condizione[0] == "rds") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dei documenti salvati",$pag)." [r7]...[/r7] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_d and $condizione[0] == "rar".$num_cond_rip_a['arr'][1]) echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dell'array",$pag)." [".fixset($nome_var["a".$num_cond_rip_a['arr'][1]])."] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
for ($num2 = 1 ; $num2 < $num_rip_a ; $num2++) if ($num1 == $num_cond_rip_a[$num2] and $condizione[0] == "rar".$num_cond_rip_a['arr'][($num2 + 1)]) echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dell'array",$pag)." [".fixset($nome_var["a".$num_cond_rip_a['arr'][($num2 + 1)]])."] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
...
if ($azione[0] == "set") {
$str_cond .= mex("porre",$pag)." [".fixset($nome_var[$azione[1]])."] ";
...
if ($azione[0] == "trunc") {
$str_cond .= mex("troncare",$pag)." [".fixset($nome_var[$azione[1]])."] ";
...
if ($azione[0] == "oper") {
$str_cond .= mex("porre",$pag)." [".fixset($nome_var[$azione[1]])."] ".mex("uguale a",$pag);
...
if ($azione[0] == "opdat") {
$str_cond .= mex("porre",$pag)." [".fixset($nome_var[$azione[1]])."] ".mex("uguale al numero di",$pag)." \"";
...
if ($azione[0] == "unset") {
$str_cond .= mex("azzera l'array",$pag)." [".fixset($nome_var[$azione[1]])."]";
if (isset($num_cond_mod) and $num_cond_mod == $num_cond) $arr_azz = $azione[1];
} # fine if ($azione[0] == "unset")

if ($azione[0] == "array") {
$str_cond .= mex("assegna all'array",$pag)." [".fixset($nome_var[$azione[1]])."] ";
...
if ($azione[2] == "cop") $str_cond .= mex("i valori dell'array",$pag)." [".fixset($nome_var[$azione[3]])."]";
if (isset($num_cond_mod) and $num_cond_mod == $num_cond) {
$array = $azione[1];
$tipo_arr = $azione[2];
...
if (substr($condizione[0],0,3) == "rar") $str_cond .= " ".mex("solo nelle ripetizioni dell'array",$pag)." [".fixset($nome_var["a".substr($condizione[0],3)])."]";
...
for ($num1 = 0 ; $num1 < $num_contratti ; $num1++) {
$num_contr = risul_query($contratti,$num1,'numero');
if ($contr_cond != $num_contr and ($attiva_contratti_consentiti == "n" or $num_contr == $contr_importa_vc or (isset($contratti_consentiti_vett[$num_contr]) and $contratti_consentiti_vett[$num_contr] == "SI"))) {
...
if ($contr_importa_vc and ($attiva_contratti_consentiti == "n" or (isset($contratti_consentiti_vett[$contr_importa_vc]) and $contratti_consentiti_vett[$contr_importa_vc] == "SI"))) {
echo "<form accept-charset=\"utf-8\" method=\"post\" action=\"$pag\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
...
} # fine if ($contr_importa_vc and ($attiva_contratti_consentiti == "n" or...
echo "<br><br>";
...
<input type=\"text\" name=\"val_allora_txt\" value=\"".htmlspecialchars(fixstr($val_allora_txt))."\" size=\"28\" maxlength=\"750\" onfocus=\"document.getElementById('val_all_txt').checked='1'\">
